...
> 的维护分支，在原作者基础上修复了网关兼容性问题（见 [本分支改动](#本分支改动-v011)）。
...
- 尺寸自适应：提示词含“竖版/人像/portrait”等 → 竖图，含“横版/横屏/landscape”等 → 横图，
  含“方图/头像/square”等 → 方图；也支持校验过的自定义 `宽x高`（16 的倍数、最长边 ≤3840、
  总像素 655,360~8,294,400、宽高比 ≤3:1）；
